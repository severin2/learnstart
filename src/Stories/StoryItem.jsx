...
/**
 * courtesy of antd's Image examples
 */
const imgFallback =
...
/**
 * Renders a single story item, renders a random image (every reload, sorry)
 * @param {*} param0
 * @returns
 */
export default function StoryItem({
  ...
  return (
    <>
      {/* only show the actions if the user is logged in */}
      {isLoggedIn && (
        <div className="StoryItem-actions">
          {showFeatureCTA && (
            <Button
              className="StoryItem-action"
              shape="round"
              size="small"
              onClick={handleOnFeatureStory}
            >
              Feature
            </Button>
          )}
